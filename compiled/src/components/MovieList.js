...
var MovieList = props => React.createElement(
  ...
  props.movies.map((movie, i) => React.createElement(
    ...
    React.createElement(
      ...
      movie.watch ? 'watched' : 'Not watched'
    ),
    " "
  ))
);
